...
class CLICommandsMixin:
    ...
    def _handle_export_command(self, command: str):
        ...
        """
        from fulilian_cli.profiles import export_profile, get_active_profile_name
    ...
    def _handle_journey_command(self, cmd_original: str) -> None:
        ...
        from cli import _cprint
        from fulilian_cli.journey import register_cli
    ...
    def _handle_paste_command(self):
        ...
        from fulilian_cli.clipboard import has_clipboard_image
    ...
    def _handle_copy_command(self, cmd_original: str) -> None:
        ...
        try:
            from fulilian_cli.clipboard import (
    ...
    def _handle_resume_command(self, cmd_original: str) -> None:
        ...
        if target.isdigit():
            ...
            from fulilian_cli.main import _resolve_session_by_name_or_id
    ...
    def _handle_worktree_command(self, cmd_original: str) -> None:
        ...
        if sub in {"prune", "gc", "clean"}:
            ...
            from fulilian_cli import worktree_gc
    ...
    def _handle_personality_command(self, cmd: str):
        ...
        if len(parts) > 1:
            ...
            if not name:
                ...
                try:
                    from fulilian_cli.config import cfg_get, read_raw_config
    ...
    def _handle_pet_command(self, cmd: str):
        ...
        from fulilian_cli.pets import _set_active, _set_enabled, print_pet_gallery, set_pet_scale, toggle_pet_display
    ...
    def _handle_hatch_command(self, cmd: str):
        ...
        from fulilian_cli.pets import _set_active
    ...
    def _handle_suggestions_command(self, cmd: str):
        ...
        args = " ".join(tokens)
        try:
            from fulilian_cli.suggestions_cmd import handle_suggestions_command
    ...
    def _handle_blueprint_command(self, cmd: str):
        ...
        try:
            from fulilian_cli.blueprint_cmd import handle_blueprint_command
    ...
    def _handle_curator_command(self, cmd: str):
        ...
        try:
            from fulilian_cli.curator import cli_main
            cli_main(tokens)
        except SystemExit:
    ...
    def _handle_skills_command(self, cmd: str):
        ...
        if args and args[0].lower() in {"pending", "approve", "apply", "reject",
            ...
            if out is not None:
                print(out)
                return
        from fulilian_cli.skills_hub import handle_skills_slash
    ...
    def _handle_init_command(self, cmd: str):
        ...
        """
        from fulilian_cli.init_command import build_init_prompt_for_cwd
    ...
    def _handle_heartbeat_command(self, cmd: str) -> None:
        ...
        if interval is None:
            ...
            return
        if interval < 0:
            from fulilian_cli.heartbeat import MIN_INTERVAL_SECONDS
    ...
    def _handle_loop_command(self, cmd: str) -> None:
        ...
        from fulilian_cli.loops import dispatch_loop_command
    ...
    def _handle_skin_command(self, cmd: str):
        ...
        try:
            from fulilian_cli.skin_engine import list_skins, set_active_skin, get_active_skin_name
        except ImportError:
    ...
    def _handle_focus_command(self, cmd_original: str) -> None:
        ...
        from fulilian_cli.colors import Colors as _Colors
    ...
    def _set_tool_progress_mode(self, mode: str) -> None:
        ...
        """
        from fulilian_cli.focus_view import normalize_tool_progress_mode
    ...
    def _note_focus_hidden_line(self, function_name: str) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from fulilian_cli.focus_view import would_display_tool_line
    ...
    def _emit_focus_recovery_line(self) -> None:
        ...
        if not getattr(self, "_focus_view_enabled", False):
            return
        from fulilian_cli.focus_view import format_hidden_line
    ...
    def _handle_indicator_command(self, cmd: str):
        ...
        """
        from cli import _ACCENT, _DIM, _RST, _cprint, save_config_value
        from fulilian_constants import DEFAULT_INDICATOR_STYLE, INDICATOR_STYLES
    ...
    def _handle_fast_command(self, cmd: str):
        ...
        try:
            from fulilian_cli.models import _is_anthropic_fast_model
            agent = getattr(self, "agent", None)
