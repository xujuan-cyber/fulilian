...
def _run_config_check_fresh() -> tuple:
    ...
    from fulilian_cli.config import check_config_version
...
def _check_and_apply_config_migration(
    *,
    ...
    try:
        from fulilian_cli.backup import restore_cron_jobs_all_profiles
...
def _validate_critical_modules_import(root) -> tuple[bool, str | None, str | None]:
    ...
    """
    from fulilian_constants import FIRST_PARTY_MODULE_ROOTS
...
def _reload_process_scan_modules() -> None:
    ...
    ``from fulilian_cli._subprocess_compat import bounded_probe_run``. If the
...
def _restore_state_db_from_snapshot(state_path: Path, snap_state: Path) -> bool:
    ...
    """
    from fulilian_cli.backup import _foreign_db_holder_pids, verify_sqlite_integrity
...
def _update_via_zip(args, *, had_desktop_app_before_update: bool = False) -> bool:
    ...
    try:
        ...
        print(
            ...
            "reinstall from https://github.com/xujuan-cyber/fulilian"
        )
        _m().sys.exit(1)
    finally:
    ...
    from fulilian_cli.managed_uv import ensure_uv, update_managed_uv
    ...
    try:
        from fulilian_cli.model_catalog import seed_cache_from_checkout
    ...
    try:
        from fulilian_cli.update_receipt import finalize_update_receipt
...
OFFICIAL_REPO_URLS = {
    "https://github.com/xujuan-cyber/fulilian.git",
    "git@github.com:xujuan-cyber/fulilian.git",
    "https://github.com/xujuan-cyber/fulilian",
    "git@github.com:xujuan-cyber/fulilian",
}

OFFICIAL_REPO_URL = "https://github.com/xujuan-cyber/fulilian.git"
...
def _current_checkout_sha() -> str | None:
    ...
    try:
        from fulilian_cli.build_info import get_code_identity
...
def _classify_concurrent_instance(pid: int) -> str:
    ...
    from fulilian_cli._scan_venv_blockers import _is_pausable_gateway  # noqa: PLC0415
...
def _refresh_active_memory_provider_dependencies() -> None:
    ...
    try:
        from fulilian_cli.memory_setup import _install_dependencies
    except Exception as exc:
...
def _install_psutil_android_compat(
    ...
    *,
    ...
    from fulilian_cli.psutil_android import PSUTIL_URL, prepare_patched_psutil_sdist
...
def _update_node_dependencies() -> list[str]:
    ...
    if not npm:
        ...
        from fulilian_constants import is_wsl
...
def _cmd_update_check(branch: str = "main", *, branch_explicit: bool = False):
    ...
    from fulilian_cli.gitlock import clear_stale_git_locks, clear_stale_tmp_packs
    ...
    if is_shallow:
        ...
        if head_sha and target_sha and head_sha == target_sha:
            ...
            from fulilian_cli.banner import _github_compare_behind
...
def _run_pre_update_backup(args) -> Optional[str]:
    ...
    try:
        ...
        try:
            from fulilian_cli.backup import create_pre_update_snapshots_all_profiles
    ...
    # Human-readable size
    from fulilian_cli.sizefmt import format_bytes
...
def _leftover_pausable_gateway_pids(
    ...
    """
    from fulilian_cli._scan_venv_blockers import _is_pausable_gateway
...
def _ledger_manual_serve_holders(
    ...
    """
    try:
        from fulilian_cli.process_identity import ledger_entries, spawner_is_dead
    except Exception:
        return []
...
def _warn_incomplete_gateway_fleet_restart(failed_units: list) -> None:
    ...
    from fulilian_cli.gateway import is_macos
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        from fulilian_cli.update_receipt import begin_update_receipt
    ...
    try:
        ...
        if not import_ok:
            ...
            print("    https://github.com/xujuan-cyber/fulilian")
        ...
        try:
            from fulilian_cli.macos_tcc_anchor import ensure_tcc_anchor
        ...
        try:
            from fulilian_cli.profiles import backfill_profile_envs
        ...
        try:
            ...
            if (
                ...
                from fulilian_cli.tools_config import install_cua_driver
        ...
        try:
            ...
            try:
                from fulilian_cli.gateway import _get_restart_exit_wait_budget
            ...
            try:
                from fulilian_cli.update_receipt import record_gateway_restart
        ...
        try:
            from fulilian_cli.update_receipt import (
        ...
        try:
            if _pre_update_plan is not None and _pre_update_plan.runtimes:
                ...
                if report_unaccounted_runtimes(_runtime_outcomes):
                    gateway_fleet_restart_incomplete = True
                try:
                    import fulilian_cli.update_receipt as _ur
            ...
            if _called_process_error_is_python_dep_install(e):
                ...
                if _m()._is_windows():
                    ...
                    print(
                        ...
                        '"from fulilian_cli.main import main; main()" update --yes'
                    )
            try:
                from fulilian_cli.update_receipt import finalize_update_receipt
