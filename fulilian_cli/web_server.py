...
from fulilian_cli._subprocess_compat import windows_detach_flags, windows_hide_flags
...
def _start_desktop_cron_ticker(stop_event: "threading.Event", interval: int = 60) -> None:
    ...
    if isinstance(provider, InProcessCronScheduler):
        try:
            from fulilian_cli.profiles import profiles_to_serve
...
def _resolve_restart_drain_timeout() -> float:
    try:
        from fulilian_cli.gateway import _get_restart_drain_timeout
...
async def _lifespan(app: "FastAPI"):
    ...
    if os.getenv("FULILIAN_DESKTOP") == "1":
        ...
        try:
            from fulilian_cli.gateway import _reap_unsupervised_gateway_orphans
...
from fulilian_cli.memory_oauth import router as _memory_oauth_router  # noqa: E402
...
# ---------------------------------------------------------------------------
from fulilian_cli.dashboard_auth.public_paths import (
...
def _dashboard_public_hosts() -> frozenset[str]:
    ...
    """
    from fulilian_cli.dashboard_auth.prefix import resolve_public_url
    ...
    if path.startswith("/api/plugins/"):
        ...
        if _authed:
            ...
            if len(parts) >= 4:
                ...
                if plugin_name:
                    try:
                        from fulilian_cli.plugins_cmd import (
                            _get_enabled_set,
                            _get_disabled_set,
                        )
...
async def _dashboard_auth_gate(request: Request, call_next):
    from fulilian_cli.dashboard_auth.middleware import gated_auth_middleware
...
async def _token_auth_seam(request: Request, call_next):
    ...
    through untouched.
    """
    from fulilian_cli.dashboard_auth.token_auth import token_auth_middleware
...
from fulilian_cli.web_models import (  # noqa: F401
    ConfigUpdate,
    EnvVarUpdate,
    EnvVarDelete,
    EnvVarReveal,
...
def _normalize_main_model_assignment(provider: str, model: str) -> tuple[str, str]:
    ...
    """
    from fulilian_cli.config import get_compatible_custom_providers
    from fulilian_cli.models import _KNOWN_PROVIDER_NAMES, normalize_provider
    from fulilian_cli.model_normalize import normalize_model_for_provider
    from fulilian_cli.providers import resolve_custom_provider, resolve_user_provider
    ...
    if (
        ...
        try:
            ...
            cur_provider = ""
        from fulilian_cli.models import _AGGREGATOR_PROVIDERS
...
from fulilian_cli import web_git as _web_git  # noqa: E402
...
from fulilian_cli.web_routers import git as _git_routes  # noqa: E402

app.include_router(_git_routes.router)
from fulilian_cli.web_routers.git import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    git_status_route,
    git_worktrees_route,
    git_branches_route,
...
def _collect_profile_gateway_topology() -> Dict[str, Any]:
    ...
    * ``profile_platforms`` — ``{profile: platforms}`` runtime platform maps
    ...
    """
    try:
        from fulilian_cli.profiles import _check_gateway_running, profiles_to_serve
...
async def get_status(profile: Optional[str] = None):
    ...
    try:
        ...
        auth_flows: list[str] = []
        try:
            from fulilian_cli.dashboard_auth import (
        ...
        try:
            from fulilian_cli.auth import get_nous_session_validity
...
def _get_portal_status_sync():
    ...
    auth: Dict[str, Any] = {}
    try:
        from fulilian_cli.auth import get_nous_auth_status_local
...
async def run_debug_share_endpoint(body: DebugShareRequest | None = None):
    ...
    *synchronous*: the whole point of ``debug share`` is the set of shareable
    ...
    """
    from fulilian_cli.debug import build_debug_share
...
async def check_fulilian_update(force: bool = False):
    ...
    try:
        from fulilian_cli.banner import check_for_updates
...
def _latest_update_receipt_summary() -> Optional[Dict[str, Any]]:
    ...
    """
    try:
        from fulilian_cli.update_receipt import read_latest_receipt
...
from fulilian_cli.web_routers import sessions as _sessions_routes  # noqa: E402

app.include_router(_sessions_routes.list_router)
from fulilian_cli.web_routers.sessions import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    get_sessions,
)


from fulilian_cli.web_routers import profiles as _profiles_routes  # noqa: E402

app.include_router(_profiles_routes.sessions_router)
from fulilian_cli.web_routers.profiles import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
...
async def get_egress_status():
    ...
    from fulilian_cli.proxy_cli import format_status_text
...
async def get_model_options(
    ...
    try:
        ...
        from fulilian_cli.inventory import build_model_options_payload, load_picker_context
...
def get_recommended_default_model(provider: str = ""):
    ...
    try:
        from fulilian_cli.inventory import build_models_payload, load_picker_context
        from fulilian_cli.models import pick_silent_default_model
...
def get_moa_models(profile: Optional[str] = None):
    ...
    try:
        from fulilian_cli.moa_config import normalize_moa_config
...
def set_moa_models(body: MoaConfigPayload, profile: Optional[str] = None):
    ...
    try:
        from fulilian_cli.moa_config import normalize_moa_config, validate_moa_payload
...
def _apply_model_assignment_sync(
    ...
    if scope == "main":
        ...
        if provider.strip().lower() == "nous":
            try:
                from fulilian_cli.nous_subscription import apply_nous_managed_defaults
        ...
        if provider.strip().lower() in {"custom", "local"} and base_url:
            try:
                from fulilian_cli.main import _auto_provider_name, _save_custom_provider
...
def _catalog_provider_env_metadata() -> dict:
    ...
    try:
        from fulilian_cli.config import OPTIONAL_ENV_VARS as _OPT
    except Exception:
        _OPT = {}
    _non_provider_keys = {
...
async def set_env_var(body: EnvVarUpdate, profile: Optional[str] = None):
    def _run():
        with _profile_scope(body.profile or profile):
            ...
            from fulilian_cli.credential_lifecycle import save_provider_env_credential
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "email": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/",
        "env_vars": (
            "EMAIL_ADDRESS",
            "EMAIL_PASSWORD",
            "EMAIL_IMAP_HOST",
    ...
    "google_chat": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/weixin/",
    ...
    "teams": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/teams",
    },
    ...
    "irc": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Fulilian from LINE via the LINE Messaging API webhook.",
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Fulilian over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Fulilian through iMessage via Photon's managed Spectrum platform.",
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Fulilian over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)",
    ...
    "webhook": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Fulilian via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
...
_OAUTH_PROVIDER_CATALOG: tuple[Dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "docs_url": "https://github.com/xujuan-cyber/fulilian/docs/guides/xai-grok-oauth",
...
def _resolve_provider_status(provider_id: str, status_fn) -> Dict[str, Any]:
    ...
    try:
        from fulilian_cli import auth as hauth
        if provider_id == "nous":
    ...
    def _run():
        with _profile_scope(profile):
            ...
            if provider_id == "anthropic":
                ...
                try:
                    from fulilian_cli.auth import clear_provider_auth
            ...
            try:
                from fulilian_cli.auth import clear_provider_auth, invalidate_nous_auth_status_cache
...
async def _start_device_code_flow(
    ...
    if provider_id == "xai-oauth":
        from fulilian_cli.auth import _xai_oauth_request_device_code
        import httpx
...
def _nous_poller(session_id: str) -> None:
    ...
    try:
        ...
        with _profile_scope(_oauth_session_profile(session_id)):
            ...
            from fulilian_cli.auth import persist_nous_credentials
...
def _codex_full_login_worker(session_id: str) -> None:
    ...
    try:
        ...
        from fulilian_cli.auth import _save_codex_tokens
...
async def get_logs(
    ...
    from fulilian_cli.logs import _read_tail, LOG_FILES
...
from fulilian_cli.web_routers import cron as _cron_routes  # noqa: E402

app.include_router(_cron_routes.router)
from fulilian_cli.web_routers.cron import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    list_cron_jobs,
    get_cron_job,
    list_cron_job_runs,
    create_cron_job,
...
def _normalize_mcp_server_create(
    ...
    """
    from fulilian_cli.mcp_config import (
...
from fulilian_cli.web_routers import mcp as _mcp_routes  # noqa: E402

app.include_router(_mcp_routes.router)
from fulilian_cli.web_routers.mcp import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    list_mcp_servers,
    add_mcp_server,
    replace_mcp_servers,
    remove_mcp_server,
...
def _mcp_oauth_callback_url(request: Request, server_name: str) -> str:
    ...
    from fulilian_cli.dashboard_auth.prefix import prefix_from_request, resolve_public_url
...
async def list_webhooks():
    import fulilian_cli.webhook as wh
...
async def list_credential_pool():
    ...
    from fulilian_cli.auth import read_credential_pool
...
async def list_hooks():
    ...
    def _run():
        ...
        try:
            from fulilian_cli.plugins import VALID_HOOKS
...
from fulilian_cli.web_routers import skills as _skills_routes  # noqa: E402

app.include_router(_skills_routes.hub_router)
from fulilian_cli.web_routers.skills import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    install_skill_hub,
    uninstall_skill_hub,
    update_skills_hub,
...
from fulilian_cli.web_routers import tools as _tools_routes  # noqa: E402

app.include_router(_tools_routes.router)
from fulilian_cli.web_routers.tools import (  # noqa: E402,F401 — legacy re-exports; tests call these via web_server.<name>
    get_toolsets,
    toggle_toolset,
    get_toolset_config,
    get_toolset_models,
...
if sys.platform.startswith("win"):
    try:
        from fulilian_cli.win_pty_bridge import WinPtyBridge as PtyBridge, PtyUnavailableError
    ...
    try:
        from fulilian_cli.pty_bridge import PtyBridge, PtyUnavailableError
        _PTY_BRIDGE_AVAILABLE = True
...
from fulilian_cli.pty_session import PtySessionRegistry, RegistryFull, run_reaper  # noqa: E402
...
def _ws_auth_reason(ws: "WebSocket") -> tuple[Optional[str], str]:
    ...
    * ``?internal=<process-credential>`` — the process-lifetime internal
    ...
    if auth_required:
        ...
        from fulilian_cli.dashboard_auth.audit import AuditEvent, audit_log
        from fulilian_cli.dashboard_auth.ws_tickets import (
            TicketInvalid,
...
def _resolve_chat_argv(
    ...
    """
    from fulilian_cli.main import PROJECT_ROOT, _apply_tui_python_env, _make_tui_argv
...
def _build_gateway_ws_url() -> Optional[str]:
    ...
    if getattr(app.state, "auth_required", False):
        from fulilian_cli.dashboard_auth.ws_tickets import internal_ws_credential
...
def _normalise_prefix(raw: Optional[str]) -> str:
    ...
    """
    from fulilian_cli.dashboard_auth.prefix import normalise_prefix
...
async def get_dashboard_plugins():
    ...
    def _run():
        ...
        try:
            from fulilian_cli.plugins_cmd import _get_enabled_set, _get_disabled_set
            enabled_set = _get_enabled_set()
            disabled_set = _get_disabled_set()
        except Exception:
            enabled_set = set()
...
async def post_agent_plugin_install(request: Request, body: _AgentPluginInstallBody):
    _require_token(request)
    from fulilian_cli.plugins_cmd import dashboard_install_plugin
...
async def post_agent_plugin_enable(request: Request, name: str):
    ...
    from fulilian_cli.plugins_cmd import dashboard_set_agent_plugin_enabled
...
async def post_agent_plugin_update(request: Request, name: str):
    _require_token(request)
    name = _validate_plugin_name(name)
    from fulilian_cli.plugins_cmd import dashboard_update_user_plugin
...
async def delete_agent_plugin(request: Request, name: str):
    _require_token(request)
    name = _validate_plugin_name(name)
    from fulilian_cli.plugins_cmd import dashboard_remove_user_plugin
...
from fulilian_cli.dashboard_auth.routes import router as _dashboard_auth_router  # noqa: E402
...
def start_server(
    ...
    try:
        from fulilian_cli.nous_auth_keepalive import start_nous_auth_keepalive
    ...
    if app.state.auth_required:
        ...
        if not list_providers():
            ...
            if host in _LOOPBACK_HOST_VALUES:
                _public_url_for_msg = ""
                try:
                    from fulilian_cli.dashboard_auth.prefix import (
            ...
            # (#54489).
            try:
                from fulilian_cli.config import load_config as _load_cfg
                from fulilian_cli.plugins_cmd import _BASIC_AUTH_PLUGIN_KEYS
    ...
    async def _serve():
        ...
        with server.capture_signals():
            ...
            try:
                from fulilian_cli.process_identity import reap_orphaned_mcp_helpers
