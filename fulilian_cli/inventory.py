...
def build_models_payload(
    ...
    *,
    ...
    try:
        from fulilian_cli.providers import is_routing_aggregator as _is_routing_aggregator
    except Exception:
...
def _append_unconfigured_rows(
    ...
    *,
    ...
    from fulilian_cli.models import CANONICAL_PROVIDERS, _PROVIDER_LABELS
