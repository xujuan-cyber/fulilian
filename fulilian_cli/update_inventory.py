...
def _detect_supervisor_for_pid(
    ...
    if pid in service_pids:
        try:
            from fulilian_cli.gateway import is_macos, supports_systemd_services
...
def collect_runtime_inventory() -> UpdatePlan:
    ...
    try:
        ...
        try:
            from fulilian_cli.image_provenance import read_image_provenance
    ...
    try:
        from fulilian_cli.gateway import find_windows_gateway_services
    ...
    try:
        from fulilian_cli.gateway import find_profile_gateway_processes
