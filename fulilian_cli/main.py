...
from fulilian_cli._subprocess_compat import suppress_platform_ver_console
...
def _run_and_exit_oneshot(
    ...
    *,
    ...
    try:
        from fulilian_cli.oneshot import run_oneshot
...
def _set_process_title() -> None:
    """Set the process title to 'fulilian' so tools like 'ps', 'top', and
...
from fulilian_cli.subcommands._shared import add_accept_hooks_flag as _add_accept_hooks_flag
from fulilian_cli.subcommands.cron import build_cron_parser
from fulilian_cli.subcommands.sync import build_sync_parser
from fulilian_cli.subcommands.gateway import build_gateway_parser
from fulilian_cli.subcommands.profile import build_profile_parser
from fulilian_cli.subcommands.model import build_model_parser
from fulilian_cli.subcommands.setup import build_setup_parser

from fulilian_cli.subcommands.whatsapp import build_whatsapp_parser
from fulilian_cli.subcommands.slack import build_slack_parser
from fulilian_cli.subcommands.login import build_login_parser
from fulilian_cli.subcommands.logout import build_logout_parser
from fulilian_cli.subcommands.auth import build_auth_parser
from fulilian_cli.subcommands.status import build_status_parser
# ── FuLiLian CTF command tree ──────────────────────────────────────
from fulilian_cli.subcommands.solve import build_solve_parser
...
from fulilian_cli.subcommands.doctor import build_doctor_parser
from fulilian_cli.subcommands.verify import build_verify_parser
from fulilian_cli.subcommands.security import build_security_parser
from fulilian_cli.subcommands.approvals import build_approvals_parser
from fulilian_cli.subcommands.dump import build_dump_parser
from fulilian_cli.subcommands.debug import build_debug_parser
from fulilian_cli.subcommands.backup import build_backup_parser
from fulilian_cli.subcommands.import_cmd import build_import_cmd_parser
from fulilian_cli.subcommands.import_agent import build_import_agent_parser
from fulilian_cli.subcommands.config import build_config_parser
from fulilian_cli.subcommands.skin import build_skin_parser
from fulilian_cli.subcommands.console import build_console_parser
from fulilian_cli.subcommands.update import build_update_parser
from fulilian_cli.subcommands.uninstall import build_uninstall_parser
from fulilian_cli.subcommands.dashboard import build_dashboard_parser
from fulilian_cli.subcommands.gui import build_gui_parser
from fulilian_cli.subcommands.logs import build_logs_parser
from fulilian_cli.subcommands.prompt_size import build_prompt_size_parser
from fulilian_cli.subcommands.memory import build_memory_parser
from fulilian_cli.subcommands.acp import build_acp_parser
from fulilian_cli.subcommands.tools import build_tools_parser
from fulilian_cli.subcommands.insights import build_insights_parser
from fulilian_cli.subcommands.monitoring import build_monitoring_parser
from fulilian_cli.subcommands.skills import build_skills_parser
from fulilian_cli.subcommands.pairing import build_pairing_parser
from fulilian_cli.subcommands.plugins import build_plugins_parser
from fulilian_cli.subcommands.mcp import build_mcp_parser
from fulilian_cli.subcommands.claw import build_claw_parser
...
if sys.platform == "win32":
    try:
        from fulilian_cli import _install_repair as _install_repair_mod
...
if _FORCE_IPV4_EARLY:
    try:
        from fulilian_constants import apply_ipv4_preference as _apply_ipv4
...
def _has_any_provider_configured() -> bool:
    ...
    if isinstance(model_cfg, dict):
        ...
        if isinstance(_default, dict):
            from fulilian_cli.config import split_model_config_default
...
def _confirm_startup_expensive_model_override(args) -> None:
    ...
    try:
        ...
        from fulilian_cli.model_selection_guards import (
            combined_message,
            selection_warnings,
        )
    except Exception as exc:
...
def _resolve_continue_arg(args, *, use_tui: bool) -> None:
    ...
    if continue_val and not getattr(args, "resume", None):
        if isinstance(continue_val, str):
            ...
            try:
                from fulilian_cli.terminal_breadcrumbs import resolve_breadcrumb_session
...
def _make_tui_argv(tui_dir: Path, tui_dev: bool) -> tuple[list[str], Path]:
    ...
    def _node_bin(bin: str) -> str:
        ...
        if not path and bin == "node":
            try:
                from fulilian_cli.dep_ensure import ensure_dependency
...
def _normalize_tui_toolsets(toolsets: object) -> list[str]:
    ...
    try:
        from fulilian_cli.oneshot import _normalize_toolsets
...
def cmd_chat(args):
    ...
    if isinstance(_resume_foreign, str) and _resume_foreign.strip().lower() in (
        ...
        from fulilian_cli.foreign_sessions import (
    ...
    try:
        ...
        from fulilian_cli.config import load_config as _load_config_for_xai_check
    ...
    if _termux_should_prefetch_update_check():
        try:
            from fulilian_cli.banner import prefetch_banner_data, prefetch_update_check
    ...
    if _skills_dir_is_unseeded():
        ...
        try:
            import fulilian_cli.banner as _banner_mod
...
def cmd_gateway(args):
    ...
    from fulilian_cli.gateway import gateway_command
...
def cmd_proxy(args):
    ...
    from fulilian_cli.proxy.cli import cmd_proxy as _cmd_proxy
...
def cmd_setup(args):
    ...
    from fulilian_cli.setup import run_setup_wizard
...
def cmd_model(args):
    ...
    if getattr(args, "refresh", False):
        try:
            from fulilian_cli.models import clear_provider_models_cache
            clear_provider_models_cache()
            print("  Cleared model picker cache.")
        except Exception:
            pass
    from fulilian_cli.setup import run_setup_action_with_navigation
...
def select_provider_and_model(args=None):
    ...
    from fulilian_cli.models import (
        CANONICAL_PROVIDERS,
        _PROVIDER_LABELS,
        _PROVIDER_ALIASES,
        group_providers,
...
def _clear_stale_openai_base_url():
    ...
    """
    from fulilian_cli.config import get_env_value, save_env_value, load_config
...
def _all_aux_tasks() -> list[tuple[str, str, str]]:
    ...
    try:
        from fulilian_cli.plugins import get_plugin_auxiliary_tasks
...
def _aux_select_for_task(task: str) -> None:
    ...
    """
    from fulilian_cli.config import load_config
    from fulilian_cli.inventory import build_aux_picker_rows, format_aux_picker_entries
...
def _aux_flow_provider_model(
    ...
    from fulilian_cli.auth import _prompt_model_selection
    from fulilian_cli.models import get_pricing_for_provider
...
def _prompt_provider_choice(choices, *, default=0, title="Select provider:"):
    ...
    """
    try:
        from fulilian_cli.setup import _curses_prompt_choice
...
def _prompt_custom_api_mode_selection(base_url: str, current_api_mode: str = "") -> Optional[str]:
    ...
    """
    from fulilian_cli.runtime_provider import _detect_api_mode_for_url
...
def __getattr__(name):
    ...
    if name in _LAZY_MODEL_EXPORTS:
        from fulilian_cli.models import _PROVIDER_MODELS
...
def _prompt_api_key(
    ...
    """
    from fulilian_cli.auth import LMSTUDIO_NOAUTH_PLACEHOLDER
    ...
    from fulilian_cli.env_loader import format_secret_source_suffix
...
def cmd_logout(args):
    ...
    from fulilian_cli.auth import logout_command
...
def cmd_auth(args):
    ...
    from fulilian_cli.auth_commands import auth_command
...
def cmd_status(args):
    ...
    from fulilian_cli.status import show_status

    show_status(args)


# ── FuLiLian CTF command handlers ──────────────────────────────────
def cmd_solve(args):
    """Solve a single CTF challenge."""
    from fulilian_ctf.cli import handle_solve_command
...
def cmd_writeup(args):
    """Auto-generate a CTF writeup."""
    from fulilian_ctf.cli import handle_writeup_command

    handle_writeup_command(args)


def cmd_replay(args):
    """Replay a challenge solution trajectory."""
    from fulilian_ctf.cli import handle_replay_command

    handle_replay_command(args)


def cmd_knowledge(args):
    """Manage the CTF knowledge base."""
...
def cmd_cron(args):
    """Cron job management."""
    from fulilian_cli.cron import cron_command
...
def cmd_webhook(args):
    ...
    from fulilian_cli.webhook import webhook_command
...
def cmd_slack(args):
    ...
    if sub == "manifest":
        from fulilian_cli.slack_cli import slack_manifest_command
...
def cmd_kanban(args):
    ...
    from fulilian_cli.kanban import kanban_command
...
def cmd_project(args):
    ...
    from fulilian_cli.projects_cmd import projects_command
...
def cmd_hooks(args):
    ...
    from fulilian_cli.hooks import hooks_command
...
def cmd_doctor(args):
    ...
    from fulilian_cli.doctor import run_doctor
...
def cmd_debug(args):
    ...
    from fulilian_cli.debug import run_debug
...
def cmd_config(args):
    ...
    from fulilian_cli.config import config_command
...
def cmd_skin(args):
    ...
    from fulilian_cli.skin_cmd import skin_command
...
def cmd_backup(args):
    ...
    if getattr(args, "quick", False):
        ...
        from fulilian_cli.backup import run_backup
...
def cmd_uninstall(args):
    ...
    if getattr(args, "gui_summary", False):
        from fulilian_cli.gui_uninstall import gui_install_summary
    ...
    if getattr(args, "gui", False):
        ...
        from fulilian_cli.uninstall import run_gui_uninstall
    ...
    from fulilian_cli.uninstall import run_uninstall
...
def _recover_core_update_marker_locked() -> None:
    ...
    try:
        from fulilian_cli import _install_repair as _ir
...
def _default_venv_install_target() -> tuple[list[str], dict[str, str] | None]:
    ...
    try:
        ...
        uv_bin = None
    if uv_bin:
        from fulilian_constants import project_venv_dir
...
def _interpreter_scripts_dir() -> Path | None:
    ...
    """
    from fulilian_constants import venv_bin_dir
...
def cmd_update(args):
    ...
    # exit 1 errors).
    from fulilian_cli.update_contract import (
    ...
    from fulilian_cli.update_lock import (
    ...
    try:
        ...
        try:
            from fulilian_cli.update_receipt import finalize_pending_update_receipt
...
def cmd_profile(args):
    ...
    if action == "list":
        ...
        from fulilian_cli import profiles as _profiles_mod
        ...
        from fulilian_cli import profile_describer as _pd
        ...
        from fulilian_cli.profiles import profile_exists, validate_alias_name
        ...
        from fulilian_cli.profiles import normalize_profile_name, rename_profile
        ...
        from fulilian_cli.profiles import export_profile
        ...
        from fulilian_cli.profiles import import_profile
        ...
        import tempfile
        from fulilian_cli.profile_distribution import (
            plan_install,
        ...
        from fulilian_cli.profiles import get_profile_dir, normalize_profile_name
        ...
        from fulilian_cli.profile_distribution import describe_distribution, DistributionError
...
def _render_distribution_plan(plan) -> None:
    ...
    from fulilian_cli.profile_distribution import MANIFEST_FILENAME
    mf = plan.manifest
...
def _maybe_setup_dashboard_auth_interactively(args) -> None:
    ...
    try:
        from fulilian_cli.web_server import should_require_dashboard_auth
    ...
    if choice == "2":
        ...
        print(
            ...
            "  Docs: https://github.com/xujuan-cyber/fulilian/docs/"
    ...
    try:
        from fulilian_cli.config import load_config, save_config
        from fulilian_cli.plugins_cmd import ensure_basic_auth_plugin_enabled_in_config
...
def _read_ssh_session_token_file(path: str) -> str:
    ...
    if sys.platform == "win32":
        from fulilian_cli.windows_ssh_runtime import read_token
...
def cmd_dashboard(args):
    ...
    from fulilian_cli.resource_limits import apply_nofile_soft_limit
    ...
    from fulilian_cli.web_server import start_server
...
def cmd_dashboard_register(args):
    ...
    from fulilian_cli.dashboard_register import cmd_dashboard_register as _impl
...
def cmd_gateway_enroll(args):
    ...
    from fulilian_cli.gateway_enroll import cmd_gateway_enroll as _impl
...
def cmd_completion(args, parser=None):
    ...
    from fulilian_cli.completion import generate_bash, generate_zsh, generate_fish
...
def cmd_prompt_size(args):
    ...
    from fulilian_cli.prompt_size import cmd_prompt_size as _impl
...
def _build_provider_choices() -> list[str]:
    ...
    try:
        from fulilian_cli.models import CANONICAL_PROVIDERS as _cp
...
def _prepare_agent_startup(args) -> None:
    ...
    if not _is_tui_chat_launch(args):
        ...
        try:
            from fulilian_cli.plugins import start_background_plugin_discovery
...
def _try_fast_chat_launch() -> bool:
    ...
    try:
        from fulilian_cli.config import get_container_exec_info
    ...
    from fulilian_cli._parser import build_top_level_parser
...
def cmd_tools(args):
    ...
    if action in {"list", "disable", "enable"}:
        from fulilian_cli.tools_config import tools_disable_enable_command

        tools_disable_enable_command(args)
    elif action == "post-setup":
        from fulilian_cli.tools_config import run_post_setup_command
...
def cmd_skills(args):
    ...
    if getattr(args, "skills_action", None) == "config":
        ...
        from fulilian_cli.skills_config import skills_command as skills_config_command

        skills_config_command(args)
    elif getattr(args, "skills_action", None) in ("trust", "untrust"):
        _cmd_skills_trust(args)
    else:
        from fulilian_cli.skills_hub import skills_command
...
def cmd_pairing(args):
    from fulilian_cli.pairing import pairing_command

    pairing_command(args)


def cmd_plugins(args):
    from fulilian_cli.plugins_cmd import plugins_command

    plugins_command(args)


def cmd_mcp(args):
    from fulilian_cli.mcp_config import mcp_command

    mcp_command(args)


def cmd_claw(args):
    from fulilian_cli.claw import claw_command
...
def main():
    ...
    try:
        from fulilian_cli.stdio import configure_windows_stdio
    ...
    from fulilian_cli.moa_cmd import cmd_moa
    ...
    # =========================================================================
    from fulilian_cli.fallback_cmd import cmd_fallback
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/xujuan-cyber/fulilian/docs/user-guide/features/fallback-providers"
        ),
    )
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/xujuan-cyber/fulilian/docs/user-guide/cli#worktree-cleanup"
        ),
    )
    ...
    def _dispatch_worktree(_args):
        from fulilian_cli.worktree_cmd import cmd_worktree
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/xujuan-cyber/fulilian/docs/user-guide/secrets/"
        ),
    )
    ...
    from fulilian_cli import secrets_cli as _secrets_cli
    from fulilian_cli import onepassword_secrets_cli as _op_secrets_cli
    ...
    egress_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://github.com/xujuan-cyber/fulilian/docs/user-guide/egress/iron-proxy"
        ),
    )

    from fulilian_cli import proxy_cli as _proxy_cli
    ...
    # migrate command
    # =========================================================================
    from fulilian_cli.migrate import cmd_migrate, cmd_migrate_xai
    ...
    # =========================================================================
    from fulilian_cli.send_cmd import register_send_subparser
    ...
    # =========================================================================
    from fulilian_cli.kanban import build_parser as _build_kanban_parser
    ...
    # =========================================================================
    from fulilian_cli.projects_cmd import build_parser as _build_project_parser
    ...
    from fulilian_cli.checkpoints import register_cli as _register_checkpoints_cli
    ...
    from fulilian_cli.bundles import register_cli as _bundles_register, bundles_command
    ...
    if _plugin_cli_discovery_needed():
        try:
            ...
            from fulilian_cli.plugins import discover_plugins, get_plugin_manager
    ...
    try:
        from fulilian_cli.curator import register_cli as _register_curator_cli
    ...
    try:
        from fulilian_cli.pets import register_cli as _register_pets_cli
    ...
    try:
        from fulilian_cli.journey import register_cli as _register_journey_cli
    ...
    def cmd_computer_use(args):
        ...
        if action == "status":
            import os as _os
            import subprocess
            from fulilian_cli.tools_config import _cua_driver_contract_status
            ...
            if path:
                version = ""
                try:
                    from fulilian_cli.tools_config import _cua_driver_env
    ...
    # FuLiLian CTF command tree
    # =========================================================================
    build_solve_parser(subparsers, cmd_solve=cmd_solve, cmd_solve_all=cmd_solve_all)
