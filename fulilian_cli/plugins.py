...
from fulilian_cli.middleware import OBSERVER_SCHEMA_VERSION, VALID_MIDDLEWARE
from fulilian_cli.plugin_capabilities import (  # noqa: F401 — re-exported
    CAPABILITY_REGISTRY,
...
class PluginContext:
    ...
    def platform_actions(self):
        ...
        if self._platform_actions is None:
            from fulilian_cli.platform_actions import PlatformActions
    ...
    def register_dashboard_auth_provider(self, provider) -> Optional[PluginRegistration]:
        ...
        """
        from fulilian_cli.dashboard_auth import DashboardAuthProvider
        from fulilian_cli.dashboard_auth.registry import (
...
class PluginManager:
    ...
    def register_approval_transport(
        ...
        *,
        ...
        from fulilian_cli.approval_transport import RegisteredApprovalTransport
    ...
    def has_enabled_portable_mcp(self, raw_config: Mapping[str, Any]) -> bool:
        ...
        for manifest in winners.values():
            ...
            if lookup_key not in enabled and manifest.name not in enabled:
                continue
            try:
                from fulilian_cli.agent_plugins import _discover_mcp
    ...
    def _load_portable_plugin(
        ...
        lookup_key = manifest.key or manifest.name
        try:
            from fulilian_cli.agent_plugins import load_agent_plugin
...
def _get_pre_tool_call_directive_details(
    ...
    from fulilian_cli.lifecycle import invoke_hook as invoke_lifecycle_hook
