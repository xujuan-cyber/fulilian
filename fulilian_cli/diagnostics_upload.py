"""Client for uploading ``fulilian debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``fulilian debug share``.
...
NAS_BASE = os.environ.get(
    "FULILIAN_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "fulilian-agent/debug-share"
