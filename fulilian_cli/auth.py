...
from fulilian_constants import OPENROUTER_BASE_URL, secure_parent_dir
...
SPOTIFY_DOCS_URL = "https://github.com/xujuan-cyber/fulilian/docs/user-guide/features/spotify"
SPOTIFY_DASHBOARD_URL = "https://developer.spotify.com/dashboard"
SPOTIFY_ACCESS_TOKEN_REFRESH_SKEW_SECONDS = 120

OAUTH_OVER_SSH_DOCS_URL = "https://github.com/xujuan-cyber/fulilian/docs/guides/oauth-over-ssh"
...
def _resolve_api_key_provider_secret(
    ...
    if provider_id == "copilot":
        ...
        try:
            from fulilian_cli.copilot_auth import resolve_copilot_token, get_copilot_api_token
...
def _get_azure_foundry_auth_status() -> Dict[str, Any]:
    ...
    try:
        from fulilian_cli.config import load_config, get_env_value_prefer_dotenv
        cfg = load_config()
    except Exception:
        cfg = {}
...
def _prompt_model_selection(
    ...
    try:
        ...
        from fulilian_cli.model_search import model_search_text
    ...
    from fulilian_cli.curses_ui import format_radio_item_ansi
...
def _save_model_choice(model_id: str) -> None:
    ...
    """
    from fulilian_cli.config import save_config, load_config
