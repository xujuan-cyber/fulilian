"""``fulilian setup`` subcommand parser.
...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure FuLiLian with an interactive wizard. "
        "Run a specific section: "
        "fulilian setup model|tts|terminal|gateway|tools|telemetry|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare 'fulilian setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",
