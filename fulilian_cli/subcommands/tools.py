"""``fulilian tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'fulilian tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # fulilian tools list [--platform cli]
    ...
    # fulilian tools disable <name...> [--platform cli]
    ...
    # fulilian tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `fulilian tools` runs after you pick a provider that\n"
