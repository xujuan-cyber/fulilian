...
def _profile_user_agent() -> str:
    """Return a ``fulilian-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from fulilian_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"fulilian-cli/{_ver}"
    except Exception:
        return "fulilian-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # fulilian-cli UA so the catalog endpoint is reachable.
