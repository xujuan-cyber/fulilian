...
def _state_dir() -> Path:
    ...
    # Default: $FULILIAN_HOME/watcher-state/, falling back to ~/.fulilian/watcher-state/.
    fulilian_home = os.environ.get("FULILIAN_HOME") or str(Path.home() / ".fulilian")
    return Path(fulilian_home) / "watcher-state"
