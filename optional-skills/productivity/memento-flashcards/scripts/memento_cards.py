...
Data file: $FULILIAN_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_FULILIAN_HOME = Path(os.environ.get("FULILIAN_HOME", Path.home() / ".fulilian"))
DATA_DIR = _FULILIAN_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
