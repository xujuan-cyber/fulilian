...
python ~/.fulilian/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.fulilian/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.fulilian/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.fulilian/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.fulilian/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.fulilian/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
