...
```bash
python ~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
