#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for FuLiLian
-------------------------------------
...
def _resolve_user(user: Optional[str]) -> str:
    ...
    sys.exit(
        ...
        f"{DEFAULT_USER_ENV} in your environment or {_fulilian_home() / '.env'}."
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for FuLiLian")
