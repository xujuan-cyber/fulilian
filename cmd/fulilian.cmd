...
rem ============================================================================
rem FuLiLian CMD Edition - fulilian.cmd
rem ============================================================================
...
rem twin of fulilian.bat next to it. Both call fll.bat with an explicit
...
if not exist "%FLL_BAT%" (
    echo [fll] ERROR: fll.bat not found next to fulilian.cmd. >&2
