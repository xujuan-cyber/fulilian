import type { BillingBlock, UsageModelData } from '@fulilian/shared/billing'
import type { FulilianSkin } from '@fulilian/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@fulilian/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = FulilianSkin
...
// Wire shapes now live in @fulilian/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
