 ...
 *
 * Symptom: in `fulilian --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@fulilian/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using fulilian --tui and as i type multiline my caret at the end will often ' +
