...
import type { ScrollBoxHandle } from '@fulilian/ink'
import { evictInkCaches } from '@fulilian/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.FULILIAN_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
