import { Box, type ScrollBoxHandle, stringWidth, Text } from '@fulilian/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (FULILIAN_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (FULILIAN_DEV_CREDITS), lowest priority,
