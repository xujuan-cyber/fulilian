 ...
 * across theme x background scenes to <tmpdir>/fulilian-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@fulilian/ink'
...
// The regenerated slate light_colors block from fulilian_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/fulilian-agent',
...
const setup = (bgHex: string) => {
  process.env.FULILIAN_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
