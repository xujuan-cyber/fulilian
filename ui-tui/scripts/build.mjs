...
await build({
  ...
  // Skip the prebuilt @fulilian/ink bundle and inline the source instead:
  ...
  alias: { '@fulilian/ink': resolve(root, 'packages/fulilian-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The fulilian_cli launcher
