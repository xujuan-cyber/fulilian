...
Configuration
-------------
Secret (lives in $FULILIAN_HOME/.env or the environment):
...
Behavioral settings (live in $FULILIAN_HOME/mem0.json, set via `fulilian memory
setup`):
  ...
  agent_id           — Agent identifier (default: fulilian)
...
_DEFAULT_USER_ID = "fulilian-user"
...
def _load_config() -> dict:
    """Load config from env vars, with $FULILIAN_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "fulilian"),
        "oss": {},
    }
    ...
    config_path = get_fulilian_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, fulilian_home):
        """Write config to $FULILIAN_HOME/mem0.json."""
        import json
    ...
    def post_setup(self, fulilian_home: str, config: dict) -> None:
        ...
        post_setup(fulilian_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $FULILIAN_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "fulilian")
