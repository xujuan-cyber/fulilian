...
from fulilian_cli import kanban_db
...
def _ws_upgrade_authorized(ws: "WebSocket") -> bool:
    ...
    """
    try:
        from fulilian_cli import web_server as _ws
    except Exception:
...
def _warnings_summary_from_diagnostics(
    ...
    if not diagnostics:
        return None
    from fulilian_cli.kanban_diagnostics import SEVERITY_ORDER
...
from fulilian_cli.kanban_db import (  # noqa: E402
...
def specify_task_endpoint(
    ...
    with kanban_db.scoped_current_board(board or kanban_db.DEFAULT_BOARD):
        ...
        from fulilian_cli import kanban_specify  # noqa: WPS433 (intentional)
...
def auto_describe_profile(profile_name: str, payload: DescribeAutoBody):
    ...
    """
    try:
        from fulilian_cli import profile_describer  # noqa: WPS433 (intentional)
