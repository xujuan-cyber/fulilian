...
// `message.content.text` before Fulilian can see it. We rewrite the two inbound
...
const MARKER = "Fulilian patch: Preserve mixed text + attachment iMessage payloads";
