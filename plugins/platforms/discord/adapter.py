...
def _format_privileged_intents_guidance(*, needs_members: bool) -> str:
    ...
    lines.extend(
        [
            ...
            "Docs: https://github.com/xujuan-cyber/fulilian/docs/user-guide/messaging/discord",
        ]
    )
    return "\n".join(lines)
...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        dropped_over_cap = 0
        try:
            from fulilian_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from fulilian_cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from fulilian_cli.commands import discord_skill_commands_by_category
