...
Config: ~/.fulilian/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.fulilian/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_fulilian_home()`` helper (FULILIAN_HOME-aware and
...
RULES_FILE = get_fulilian_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_fulilian_home() / "feishu_comment_pairing.json"
