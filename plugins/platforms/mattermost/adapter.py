...
required — uses aiohttp which is already a Fulilian dependency.
...
def interactive_setup() -> None:
    ...
    ``fulilian_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Fulilian delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # fulilian_cli/setup.py::_setup_mattermost function.
