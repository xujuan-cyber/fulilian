...
``_check_spotify_available()`` — when the user has not run ``fulilian auth
spotify``, the tools remain registered (so they appear in ``fulilian
...
The Spotify auth flow (``fulilian auth spotify``), CLI plumbing, and docs
