...
def _make_agent():
    fulilian_home = Path(tempfile.mkdtemp(prefix="fulilian-test-home-"))
    (fulilian_home / "logs").mkdir(parents=True, exist_ok=True)
    with (
        patch(
        ...
        patch("run_agent._fulilian_home", fulilian_home),
