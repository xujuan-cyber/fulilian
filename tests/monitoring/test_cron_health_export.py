...
def test_registered_observable_metric_names_cover_snapshot_metrics(monkeypatch):
    ...
    gateway_snapshot = type("S", (), {"metrics": [
        _M("fulilian.gateway.up"), _M("fulilian.gateway.active_agents"),
        _M("fulilian.gateway.busy"), _M("fulilian.gateway.drainable"),
        _M("fulilian.gateway.restart_requested"),
        _M("fulilian.platform.up"), _M("fulilian.platform.degraded"),
    ]})()
    cron_snapshot = type("S", (), {"metrics": [
        _M("fulilian.cron.scheduler.heartbeat_age_seconds"),
        _M("fulilian.cron.scheduler.last_success_age_seconds"),
        _M("fulilian.cron.scheduler.catch_up_occurrences"),
        _M("fulilian.cron.jobs.enabled"), _M("fulilian.cron.jobs.running"),
        _M("fulilian.cron.jobs.overdue"),
    ]})()
...
def test_monitoring_docs_distinguish_relay_health_scope_and_terminal_flush():
    ...
    assert "FuLiLian-owned Relay transport health" in text
