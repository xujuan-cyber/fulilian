...
The unit tests in tests/fulilian_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned fulilian-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/fulilian")
from fulilian_cli.service_manager import S6ServiceManager
