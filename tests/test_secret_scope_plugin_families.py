...
class TestMemoryFamily:
    ...
    def test_supermemory_post_setup_no_environ_write_under_multiplex(
        ...
        import fulilian_cli.config as cli_config
...
class TestGoogleMeetSpawn:
    def test_child_env_carries_scoped_openai_key(
        ...
        monkeypatch.delenv("FULILIAN_MEET_REALTIME_KEY", raising=False)
        ...
        assert child_env["FULILIAN_MEET_REALTIME_KEY"] == "scoped-openai-key"
    ...
    def test_explicit_key_argument_still_wins(
        ...
        assert captured["env"]["FULILIAN_MEET_REALTIME_KEY"] == "explicit-key"
