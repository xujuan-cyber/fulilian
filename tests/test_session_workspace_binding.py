"""Session <-> workspace grouping key (fulilian_state.workspace_key).

The key is what `fulilian sessions list --workspace` groups/filters on. It is a
...
from fulilian_state import workspace_key
