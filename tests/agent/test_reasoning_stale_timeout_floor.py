...
thinking phase.  Fulilian's default cloud-stream stale detector
(``FULILIAN_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``FULILIAN_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
