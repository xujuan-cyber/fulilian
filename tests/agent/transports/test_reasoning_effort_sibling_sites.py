...
class TestKimiEffortVocabulary:
    def test_k3_maps_full_fulilian_ladder(self):
        expected = {
            "minimal": "low",
            "low": "low",
            "medium": "high",
        ...
        for fulilian_level, wire_level in expected.items():
            kw = _kimi_kwargs(
                "kimi-k3", {"enabled": True, "effort": fulilian_level}
            )
            assert kw["reasoning_effort"] == wire_level, fulilian_level
