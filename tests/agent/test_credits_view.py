...
from fulilian_cli.nous_account import NousPortalAccountInfo, NousPaidServiceAccessInfo
...
def test_credits_command_fully_removed():
    ...
    from fulilian_cli.commands import resolve_command, COMMAND_REGISTRY
