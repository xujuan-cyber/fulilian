...
manipulation. Fulilian keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point FULILIAN_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_fulilian_home /
    get_default_fulilian_root) instead of monkeypatching private helpers —
    ...
    FULILIAN_HOME=<root>/profiles/<name> makes get_default_fulilian_root()
