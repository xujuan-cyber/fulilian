...
class TestGetCopilotModelContext:
    ...
    @patch("fulilian_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("fulilian_cli.models._urlopen_model_catalog_request")
    ...
    @patch("fulilian_cli.models.fetch_github_model_catalog", return_value=[])
