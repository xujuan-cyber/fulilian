...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("FULILIAN_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test FULILIAN_HOME."""
    monkeypatch.setenv("FULILIAN_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # FULILIAN_HOME patch the client/profile_dir fixtures installed.
