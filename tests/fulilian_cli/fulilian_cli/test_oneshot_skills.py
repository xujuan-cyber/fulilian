...
The oneshot path builds its AIAgent directly (bypassing FulilianCLI), so the
...
from fulilian_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
