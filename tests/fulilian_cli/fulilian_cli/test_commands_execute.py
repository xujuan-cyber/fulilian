...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`fulilian_cli.slash_exec.EXECUTORS`, and
...
from fulilian_cli.commands import COMMAND_REGISTRY, resolve_command
from fulilian_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
