"""Tests for fulilian_cli.copilot_auth — Copilot token validation and resolution."""
...
class TestResolveToken:
    ...
    def test_gh_cli_classic_pat_raises(self, monkeypatch):
        ...
        with patch("fulilian_cli.copilot_auth._try_gh_cli_token", return_value="ghp_classic"):
...
class TestGhCliTokenCache:
    ...
    def test_miss_is_cached_and_probe_runs_once(self):
        from fulilian_cli import copilot_auth
        self._reset()
...
class TestRequestHeaders:
    ...
    def test_default_headers_include_openai_intent(self):
        ...
        assert headers["User-Agent"] == "FulilianAgent/1.0"
