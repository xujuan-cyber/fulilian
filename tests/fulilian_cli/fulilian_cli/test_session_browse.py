"""Tests for the interactive session browser (`fulilian sessions browse`).
...
from fulilian_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """fulilian sessions browse should be parseable."""
