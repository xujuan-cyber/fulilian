"""Tests for `fulilian secrets bitwarden token` / `fulilian secrets onepassword token`.
...
from fulilian_cli import onepassword_secrets_cli as op_cli
from fulilian_cli import secrets_cli as bw_cli
