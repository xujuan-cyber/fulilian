"""Tests for ``fulilian approvals suggest`` (fulilian_cli/approvals_suggest.py).

Approval history in Fulilian is implied, not ledgered: the session DB
...
from fulilian_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
