...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (fulilian_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_fulilian_overlays():
    """fulilian_cli.providers.get_provider("vertex") backs
