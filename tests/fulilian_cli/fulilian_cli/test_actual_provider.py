...
from fulilian_cli.providers import normalize_provider as normalize_overlay_provider
...
def test_actual_profile_fetch_models_normalizes_env_base_url(monkeypatch):
    ...
    monkeypatch.setattr("fulilian_cli.urllib_security.open_credentialed_url", _open)
