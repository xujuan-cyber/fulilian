...
The canonical profile id ("default" for ~/.fulilian) is never touched —
...
def profile_env(tmp_path, monkeypatch):
    """Isolated environment: Path.home() and FULILIAN_HOME under tmp_path."""
...
class TestRenameDefault:
    ...
    def test_named_rename_still_real_and_keeps_display_name(
        ...
        monkeypatch.setattr(
            "fulilian_cli.profiles.check_alias_collision", lambda name: "skip"
        )
