"""Tests for the auxiliary-model configuration UI in ``fulilian model``.
...
from fulilian_cli.config import DEFAULT_CONFIG, load_config
...
def test_reset_aux_clears_delegation_routing_preserves_settings(tmp_path, monkeypatch):
    ...
    from fulilian_cli.config import load_config as _lc, save_config
