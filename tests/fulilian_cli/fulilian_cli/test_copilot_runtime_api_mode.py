...
def test_copilot_runtime_api_mode_uses_target_model_over_stale_config_default(monkeypatch):
    ...
    monkeypatch.setattr(
        "fulilian_cli.models.copilot_model_api_mode",
...
@pytest.mark.parametrize("credential_source", ["pool", "explicit", "env", "fulilian-auth-store"])
...
def test_resolver_routes_copilot_by_target_model_for_every_credential_path(
    ...
    from fulilian_cli import models
    from fulilian_cli import runtime_provider as rp
