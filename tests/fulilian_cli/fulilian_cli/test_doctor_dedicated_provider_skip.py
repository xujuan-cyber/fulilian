"""Regression: fulilian doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at fulilian_cli/doctor.py already covers
...
def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from fulilian_cli import doctor
