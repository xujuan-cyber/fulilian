"""Tests for `_can_open_graphical_browser()` in fulilian_cli.auth.

Guards the fix for the May 2026 report where `fulilian auth add xai-oauth`
...
from fulilian_cli.auth import _can_open_graphical_browser
