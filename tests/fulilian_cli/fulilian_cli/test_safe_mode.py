"""Tests for `fulilian chat --safe-mode` isolation."""
...
_VARS = ("FULILIAN_SAFE_MODE", "FULILIAN_IGNORE_USER_CONFIG", "FULILIAN_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["FULILIAN_SAFE_MODE"] == "1"
        assert os.environ["FULILIAN_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["FULILIAN_IGNORE_RULES"] == "1"
        return True
