"""Tests for the shared byte formatter (fulilian_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from fulilian_cli.backup import _format_size as backup
    from fulilian_cli.checkpoints import _fmt_bytes as checkpoints
    from fulilian_cli.doctor import _human_bytes as doctor
