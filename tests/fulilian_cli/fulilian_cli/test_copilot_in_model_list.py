...
def test_copilot_picker_uses_live_catalog_when_available():
    ...
    with patch("agent.models_dev.fetch_models_dev", return_value={}), \
         patch("fulilian_cli.models._resolve_copilot_catalog_api_key", return_value="gh-token"), \
         patch("fulilian_cli.models._fetch_github_models", return_value=live_models):
