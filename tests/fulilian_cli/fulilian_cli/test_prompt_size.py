"""Tests for the ``fulilian prompt-size`` diagnostic (issue #34667)."""
...
from fulilian_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(fulilian_home, memory_text="", user_text=""):
    mem_dir = fulilian_home / "memories"
...
def _seed_skill(fulilian_home, name, description):
    skill_dir = fulilian_home / "skills" / "demo" / name
