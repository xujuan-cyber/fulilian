...
from fulilian_cli import session_recovery
from fulilian_cli.session_lost_and_found import (
...
from fulilian_cli.session_lost_and_found import find_sqlite3_cli
...
def test_unreadable_schema_without_cli_names_the_sqlite3_requirement(
    ...
    import fulilian_cli.session_lost_and_found as laf
...
def test_fingerprint_error_enumerates_parent_cli_session(
    ...
    message = str(excinfo.value)
    assert "Stop every Fulilian process" in message
