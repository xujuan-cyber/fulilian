"""Regression: ``fulilian update`` should take a managed checkout off autocrlf=true.
...
``fulilian update`` has to repair them.
...
from fulilian_cli.update_cmd import _normalize_managed_eol
