"""Tests for the specifier module + `fulilian kanban specify` CLI surface.
...
from fulilian_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `fulilian kanban …` argparse surface directly."""
