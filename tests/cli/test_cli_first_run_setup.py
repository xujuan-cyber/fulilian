...
def test_credentials_ready_false_when_no_provider(monkeypatch):
    ...
    monkeypatch.setattr("fulilian_cli.runtime_provider.resolve_runtime_provider", _raise)
...
def test_offer_first_run_setup_routes_into_shared_picker(monkeypatch):
    ...
    monkeypatch.setattr("fulilian_cli.main.select_provider_and_model", _fake_picker)
...
def test_offer_first_run_setup_declined(monkeypatch):
    ...
    monkeypatch.setattr("fulilian_cli.main.select_provider_and_model", _fail_picker)
...
def test_offer_first_run_setup_picker_cancel_is_graceful(monkeypatch):
    ...
    monkeypatch.setattr("fulilian_cli.main.select_provider_and_model", _cancel_picker)
...
def test_empty_key_error_names_actual_provider(monkeypatch, capsys):
    ...
    assert "fulilian model" in out or "fulilian setup" in out
