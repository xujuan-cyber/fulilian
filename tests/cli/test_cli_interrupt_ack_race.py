...
Root cause: ``FulilianCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a FulilianCLI with prompt_toolkit stubbed (same pattern as
