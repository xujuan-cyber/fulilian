...
from fulilian_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/fulilian_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("fulilian_cli.lifecycle.invoke_hook")
@patch("fulilian_cli.lifecycle.finalize_session")
