"""Tests for the ``/reload-skills`` CLI slash command (``FulilianCLI._reload_skills``).
...
def _make_cli():
    """Build a minimal FulilianCLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.FulilianCLI)
