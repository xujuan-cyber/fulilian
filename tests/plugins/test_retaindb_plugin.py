...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure FULILIAN_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", fulilian_home=str(tmp_path / ".fulilian"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("FULILIAN_HOME", str(fulilian_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", fulilian_home=str(fulilian_home))
        return p
