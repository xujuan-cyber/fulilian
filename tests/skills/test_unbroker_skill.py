...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and fulilian-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # fulilian-agent (tests/skills/)
]
