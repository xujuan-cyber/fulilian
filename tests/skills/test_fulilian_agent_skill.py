"""The `fulilian-agent` skill is what a running Fulilian knows about itself.

`website/` is never packaged, so an installed Fulilian has no local copy of the
user guide; skills ARE synced into `$FULILIAN_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Fulilian can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "fulilian-agent"
