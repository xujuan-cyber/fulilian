...
* ``fulilian_constants.get_fulilian_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_fulilian_dir so cache writes land under tmp_path."""
    ...
    with patch("fulilian_constants.get_fulilian_dir", _fake_get):
        yield cache_dir
