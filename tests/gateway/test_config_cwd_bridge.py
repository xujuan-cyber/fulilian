...
class TestTopLevelCwdAlias:
    ...
    def test_top_level_cwd_and_backend(self):
        cfg = {"backend": "local", "cwd": "/home/fulilian/projects"}
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/fulilian/projects"
    ...
    def test_nested_terminal_takes_precedence_over_top_level(self):
        ...
        cfg = {
            "cwd": "/should/not/use",
            "terminal": {"cwd": "/home/fulilian/real"},
        }
        result = _simulate_config_bridge(cfg)
        assert result["TERMINAL_CWD"] == "/home/fulilian/real"


    def test_no_cwd_falls_back_to_messaging_cwd(self):
        cfg = {}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/fulilian/projects"})
        assert result["TERMINAL_CWD"] == "/home/fulilian/projects"
    ...
    def test_dot_cwd_triggers_messaging_fallback(self):
        ...
        cfg = {"cwd": "."}
        result = _simulate_config_bridge(cfg, {"MESSAGING_CWD": "/home/fulilian"})
        ...
        assert result["TERMINAL_CWD"] == "/home/fulilian"
