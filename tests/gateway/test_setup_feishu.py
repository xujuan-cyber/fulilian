"""Tests for _setup_feishu() in fulilian_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("fulilian_cli.config.save_env_value", side_effect=mock_save), \
         patch("fulilian_cli.config.get_env_value", side_effect=mock_get), \
         patch("fulilian_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("fulilian_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("fulilian_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("fulilian_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("fulilian_cli.cli_output.print_header"), \
         patch("fulilian_cli.cli_output.print_info"), \
         patch("fulilian_cli.cli_output.print_success"), \
         patch("fulilian_cli.cli_output.print_warning"), \
         patch("fulilian_cli.cli_output.print_error"), \
