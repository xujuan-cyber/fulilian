...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.fulilian/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at fulilian_state import time, before pytest's FULILIAN_HOME monkeypatch
    fires — the autouse fixture's FULILIAN_HOME override doesn't help here.)
    """
