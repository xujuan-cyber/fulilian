...
the shared /blueprint command handler (fulilian_cli/blueprint_cmd.py), and
the docs generator. Uses an isolated FULILIAN_HOME for anything that touches the
cron job store.
"""
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("fulilian://blueprint/morning-brief?")
