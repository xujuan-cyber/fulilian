---
sidebar_position: 8
title: "Use Voice Mode with Fulilian"
description: "A practical guide to setting up and using Fulilian voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Fulilian
...
- you want Fulilian sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Fulilian.
...
## Step 1: make sure normal Fulilian works first
...
Fulilian supports both local and cloud speech stacks.
...
4. Fulilian transcribes and responds
...
- asking Fulilian to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Fulilian loop.

## Tuning CLI behavior

### Silence threshold

If Fulilian starts/stops too aggressively, tune:
...
Fulilian stays a normal chat bot, but can speak replies.
...
- you want Fulilian to function like a portable research or ops assistant
...
Fulilian joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Fulilian detects speech boundaries
- transcripts are posted in the associated text channel
- Fulilian responds in text and audio
...
1. get text Fulilian working
2. run `fulilian setup tts` to enable voice support
