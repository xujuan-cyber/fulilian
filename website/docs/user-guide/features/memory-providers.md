...
See the [config reference](https://github.com/xujuan-cyber/fulilian/blob/main/plugins/memory/honcho/README.md) and [Honcho integration guide](https://docs.honcho.dev/v3/guides/integrations/fulilian).
...
See [plugin README](https://github.com/xujuan-cyber/fulilian/blob/main/plugins/memory/hindsight/README.md) for the full configuration reference.
