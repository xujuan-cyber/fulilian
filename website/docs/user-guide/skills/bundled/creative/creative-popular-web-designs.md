...
| Version | `1.0.0` |
| Author | FuLiLian + Teknium (design systems sourced from VoltAgent/awesome-design-md) |
| License | MIT |
...
Each template includes a **Fulilian Implementation Notes** block at the top with:
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template's Fulilian notes -->
