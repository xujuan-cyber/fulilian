...
```bash
python3 -m pyfiglet "FULILIAN" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=FULILIAN&font=Slant" | boxes -d stone
```
