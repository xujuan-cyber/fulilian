...
Set your Tenor API key in your environment (add to `${FULILIAN_HOME:-~/.fulilian}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/xujuan-cyber/fulilian/blob/main/skills/media/gif-search/url)`
