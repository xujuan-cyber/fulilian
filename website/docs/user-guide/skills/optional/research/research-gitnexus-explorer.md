...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/research/gitnexus-explorer` |
...
| Related skills | [`fulilian-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-fulilian-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  fulilian-agent users don't need.
