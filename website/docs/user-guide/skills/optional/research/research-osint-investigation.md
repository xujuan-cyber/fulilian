...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | FuLiLian (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $FULILIAN_OSINT_CACHE/icij/ (default: ~/.cache/fulilian-osint/icij/).
...
# Set FULILIAN_OSINT_UA=your-app/1.0 (your@email) to identify yourself
