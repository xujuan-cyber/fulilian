...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`fulilian-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-fulilian-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
FuLiLian via the native MCP client. This is the preferred
...
Then configure FuLiLian to connect via HTTP:
