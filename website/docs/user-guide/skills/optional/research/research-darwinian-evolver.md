...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), FuLiLian |
| License | MIT |
...
import upstream classes into Fulilian itself.
...
Open `~/.fulilian/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Fulilian core.
   Custom driver scripts under `~/.fulilian/skills/...` are user-side and fine.
