...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), FuLiLian |
| License | MIT |
...
```
SCRIPT=~/.fulilian/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.fulilian/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
