...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.fulilian/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.fulilian/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Fulilian installs package this)
