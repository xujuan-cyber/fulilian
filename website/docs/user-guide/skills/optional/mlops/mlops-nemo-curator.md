...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/mlops/nemo-curator` |
...
- **[Filtering Guide](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/mlops/nemo-curator/references/filtering.md)** - 30+ quality filters, heuristics
- **[Deduplication Guide](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/mlops/nemo-curator/references/deduplication.md)** - Exact, fuzzy, semantic methods
