...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/web-development/page-agent` |
...
- User wants **Fulilian itself to drive a browser** → use Fulilian' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
