...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/software-development/code-wiki` |
...
Invoke through the `terminal` tool from the target repo's root, then use `read_file` / `search_files` / `write_file` to produce the wiki. Default output location is `~/.fulilian/wikis/<repo-name>/`. Only write into the repo (`docs/wiki/`) when the user explicitly requests it.
...
```bash
OUTPUT_DIR="$HOME/.fulilian/wikis/$REPO_NAME"
...
- [`path/to/main.py`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>) — <what runs when you start it>
- [`path/to/cli.py`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>) — <CLI surface>

## High-Level Architecture

<2-3 sentences. Detail goes in architecture.md.>

See [architecture.md](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/architecture.md).

## Module Map

| Module | Purpose |
|---|---|
| [`<module>`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md) | <one-line purpose> |

## Getting Started

See [getting-started.md](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/getting-started.md).
````
...
- **<Component>** — <1-2 sentences>. See [`modules/<module>.md`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/modules/<module>.md).
...
1. **<Step>** — [`<file>`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>)
2. **<Step>** — [`<file>`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>)
...
- [`<module>/<file>`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>) — <what it does>
...
1. **User input** — [`cli.py:FulilianCLI.run_session`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>)
2. **Message dispatch** — [`run_agent.py:AIAgent.chat`](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/<link>)
````
...
- Architecture: [architecture.md](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/architecture.md)
- Module reference: [README.md#module-map](https://github.com/xujuan-cyber/fulilian/blob/main/optional-skills/software-development/code-wiki/README.md#module-map)
````
...
cat > "$OUTPUT_DIR/.codewiki-state.json" <<EOF
{
  ...
  "generator": "fulilian-agent code-wiki skill v0.1.0",
  "modules_documented": []
}
EOF
```
...
```
Generated wiki at ~/.fulilian/wikis/<repo-name>/:
...
- **In-repo output without asking.** Default is `~/.fulilian/wikis/`. Only write into the repo when the user explicitly requests it.
