...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/productivity/canvas` |
...
4. Name the token (e.g., "FuLiLian"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${FULILIAN_HOME:-~/.fulilian}/.env`:
