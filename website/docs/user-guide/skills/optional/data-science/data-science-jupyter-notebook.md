...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing fulilian tool access (web_search, file ops). Stateless. |
