...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), FuLiLian |
| License | MIT |
...
The script reads `${FULILIAN_HOME:-~/.fulilian}/.env` for two optional defaults:
...
Helper script: `~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${FULILIAN_HOME:-~/.fulilian}/.env`.
...
```bash
python3 ~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.fulilian/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
