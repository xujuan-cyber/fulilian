...
| | |
|---|---|
| Source | Optional — install with `fulilian skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), FuLiLian |
| License | MIT |
...
Helper script path: `~/.fulilian/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.fulilian/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.fulilian/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.fulilian/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
