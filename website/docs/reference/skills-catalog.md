...
| [`fulilian-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-fulilian-agent) | Use, configure, theme, extend, and orchestrate FuLiLian. | `autonomous-ai-agents/fulilian-agent` |
...
| [`fulilian-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-fulilian-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/fulilian-agent-skill-authoring` |
| [`inspecting-fulilian-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-fulilian-desktop-dom) | Read the live Fulilian desktop DOM/CSS over CDP. | `software-development/inspecting-fulilian-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .fulilian/plans/; no execution. | `software-development/plan` |
