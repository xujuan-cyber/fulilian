...
* Implementation: [`agent/plugin_llm.py`](https://github.com/xujuan-cyber/fulilian/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/xujuan-cyber/fulilian/blob/main/tests/agent/test_plugin_llm.py)
