  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the FuLiLian community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Fulilian &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Fulilian?{' '}
        <a
          href="https://github.com/xujuan-cyber/fulilian/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
