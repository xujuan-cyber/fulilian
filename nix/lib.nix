      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via FULILIAN_BUNDLED_SKILLS /
            # FULILIAN_OPTIONAL_SKILLS (see fulilian-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + FULILIAN_BUNDLED_LOCALES
            # / FULILIAN_OPTIONAL_MCPS, not via the wheel. Excluding them
