"""Core NeMo Relay adapter for Fulilian tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Fulilian tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Fulilian Relay tool execution cannot run on an active event-loop thread"
    )
