...
# ``data:`` field before Fulilian receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and Fulilian persists a content-less
...
# Request parameters that Fulilian sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # fulilian_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from fulilian_cli.plugins import get_plugin_error_classification
