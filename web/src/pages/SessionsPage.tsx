...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    fulilian_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__fulilian_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Fulilian-Session-Token":
              (window as unknown as { __FULILIAN_SESSION_TOKEN__?: string })
                .__FULILIAN_SESSION_TOKEN__ ?? "",
          },
        });
