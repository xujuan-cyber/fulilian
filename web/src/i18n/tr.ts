...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateFulilian: "Fulilian'i Güncelle",
    updatingFulilian: "Fulilian güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Fulilian eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`fulilian plugins` ile eşdeğer).",
    ...
    removeConfirm: "Bu eklenti ~/.fulilian/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.fulilian/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.fulilian/skills/ adresinden yüklenir",
  ...
  env: {
    ...
    customHint: ".env dosyanızda saklanan ve Fulilian'in tanımadığı rastgele ortam değişkenleri. Bunları beceriler, MCP sunucuları veya kendi araçlarınız için ortam değişkenleri eklemek için kullanın.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Fulilian rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Fulilian oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Fulilian'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Fulilian ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Fulilian yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
