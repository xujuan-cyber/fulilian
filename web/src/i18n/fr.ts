...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateFulilian: "Mettre à jour Fulilian",
    updatingFulilian: "Mise à jour de Fulilian…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Fulilian (parité avec `fulilian plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.fulilian/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.fulilian/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.fulilian/skills/",
  ...
  env: {
    ...
    customHint: "Variables d'environnement arbitraires stockées dans votre .env que Fulilian ne reconnaît pas. Utilisez-les pour injecter des variables d'environnement pour des compétences, des serveurs MCP ou vos propres outils.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badges Fulilian à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Fulilian en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Fulilian davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Fulilian détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Fulilian analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
