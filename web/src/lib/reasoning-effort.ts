 ...
 *
 * Values mirror fulilian_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Fulilian default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Fulilian' default when unset). */
