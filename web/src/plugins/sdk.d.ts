/**
 * Fulilian Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__FULILIAN_PLUGIN_SDK__`` and
 * ``window.__FULILIAN_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__FULILIAN_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``FulilianPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@fulilian/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__FULILIAN_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__FULILIAN_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__FULILIAN_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface FulilianPluginSDK {
...
declare global {
  interface Window {
    __FULILIAN_PLUGIN_SDK__?: FulilianPluginSDK;
    __FULILIAN_PLUGINS__?: PluginRegistry;
  }
}
