 ...
 * `window.__FULILIAN_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Fulilian brand in the top bar
 ...
 *  `window.__FULILIAN_PLUGINS__.registerSlot(...)`.
 *
