 ...
 *
 * Plugins call window.__FULILIAN_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__FULILIAN_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__FULILIAN_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__FULILIAN_PLUGIN_SDK__ = {
    ...
    // window.__FULILIAN_SESSION_TOKEN__ directly.
    authedFetch,
