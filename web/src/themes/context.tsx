...
const STORAGE_KEY = "fulilian-dashboard-theme";
...
const FONT_STORAGE_KEY = "fulilian-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `fulilian_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "fulilian-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-fulilian-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-fulilian-theme-font", "true");
