 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `fulilian_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Fulilian Teal",
  description: "Classic dark teal — the canonical Fulilian look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Fulilian Teal (Large)",
  description: "Fulilian Teal with bigger fonts and roomier spacing",
