#!/usr/bin/env python3
"""
SWE Runner with Fulilian Trajectory Format

A runner that uses Fulilian-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Fulilian-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Fulilian-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Fulilian format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Fulilian-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Fulilian-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Fulilian Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Fulilian-Agent's built-in execution environments
    and outputs trajectories in Fulilian-Agent format.
    """
    ...
    def _convert_to_fulilian_format(
        self,
        ...
        """
        Convert internal message format to Fulilian trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Fulilian trajectory format
        trajectory = self._convert_to_fulilian_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Fulilian trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Fulilian Trajectory Format")
    print("=" * 60)
