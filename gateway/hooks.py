...
Hooks are discovered from ~/.fulilian/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Fulilian session id
...
HOOKS_DIR = get_fulilian_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"fulilian_hook_{hook_name}"
