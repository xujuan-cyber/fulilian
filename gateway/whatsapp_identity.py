...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$FULILIAN_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_fulilian_dir("platforms/whatsapp/session", "whatsapp/session")
