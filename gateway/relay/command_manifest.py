...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Fulilian session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Fulilian session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Fulilian agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update FuLiLian to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Fulilian gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Fulilian session in it",
