"""Shared Fulilian-side execution flow for Modal transports.

This module deliberately stops at the Fulilian boundary:
- command preparation
...
def wrap_modal_stdin_heredoc(command: str, stdin_data: str) -> str:
    ...
    marker = f"FULILIAN_EOF_{uuid.uuid4().hex[:8]}"
