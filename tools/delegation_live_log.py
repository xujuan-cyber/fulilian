...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.fulilian)."""
    from fulilian_constants import get_fulilian_dir

    return get_fulilian_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Fulilian subagent live transcript ===",
