#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the Fulilian desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the Fulilian desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "Fulilian desktop GUI (the pane open_preview opens beside this chat). Call "
