...
Trust levels:
  - builtin:   Ships with Fulilian. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.fulilian/\.env|\~/\.fulilian/\.env',
     "fulilian_env_access", "critical", "exfiltration",
     "directly references Fulilian secrets file"),
    ...
    (r'\.fulilian/config\.yaml|\.fulilian/SOUL\.md',
     "fulilian_config_mod", "critical", "persistence",
     "references Fulilian configuration files directly"),
...
# scan. `.skillignore` is the Fulilian-native name; `.clawhubignore` is honored
