...
`hey_fulilian.onnx` / `hey_fulilian.tflite` — the on-device "Hey Fulilian" hotword
...
- **Label:** the model registers as `hey_fulilian` (matches the filename).
