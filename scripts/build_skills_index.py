#!/usr/bin/env python3
"""Build the Fulilian Skills Index — a centralized JSON catalog of all skills.
...
`fulilian skills search/install` can use it without hitting the GitHub API.
...
# Ensure FULILIAN_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Fulilian Skills Index...", flush=True)
