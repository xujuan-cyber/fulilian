...
# FuLiLian ☤
<p align="center">
  <a href="https://hermes-agent.nousresearch.com/">FuLiLian</a> | <a href="https://hermes-agent.nousresearch.com/">Fulilian Desktop</a>
</p>
<p align="center">
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://hermes-agent.nousresearch.com/docs/getting-started/termux). En Termux, Fulilian instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
Esto te autentica vía OAuth, establece Nous como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `fulilian portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://hermes-agent.nousresearch.com/docs/user-guide/features/tool-gateway).
...
Toda la documentación está en **[fulilian-agent.nousresearch.com/docs](https://hermes-agent.nousresearch.com/docs/)**:
