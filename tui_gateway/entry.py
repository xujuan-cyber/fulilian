...
def wait_for_mcp_discovery(timeout: "float | None" = None) -> None:
    ...
    if thread is not None and thread.is_alive():
        try:
            from fulilian_cli.mcp_startup import _resolve_discovery_timeout
...
def join_mcp_discovery(timeout: float | None = None) -> bool:
    ...
    try:
        from fulilian_cli.mcp_startup import join_mcp_discovery as _startup_join
...
def _has_configured_mcp_servers() -> bool:
    ...
    from fulilian_cli.mcp_startup import _has_configured_mcp_servers as configured
...
def main():
    ...
    try:
        from fulilian_cli.model_switch import prewarm_picker_cache_async
