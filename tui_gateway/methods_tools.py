...
def _(rid, params: dict) -> dict:
    ...
    """
    try:
        from fulilian_cli.config import reload_env
...
def _(rid, params: dict) -> dict:
    ...
    try:
        from fulilian_cli.commands import (
            COMMAND_REGISTRY,
            SUBCOMMANDS,
            _build_description,
...
def _(rid, params: dict) -> dict:
    ...
    if name == "moa":
        ...
        try:
            from fulilian_cli.moa_config import moa_usage, normalize_moa_config
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if action == "install":
            from fulilian_cli.skills_hub import do_install
        ...
        if action == "browse":
            from fulilian_cli.skills_hub import browse_skills
        ...
        if action == "inspect":
            from fulilian_cli.skills_hub import inspect_skill
...
def _(rid, params: dict) -> dict:
    ...
    if err:
        return err
    try:
        from fulilian_cli.config import load_config, save_config, save_env_value
        from fulilian_cli.mcp_config import (
...
def _(rid, params: dict) -> dict:
    ...
    if err:
        return err
    try:
        from fulilian_cli.mcp_config import _remove_mcp_server
