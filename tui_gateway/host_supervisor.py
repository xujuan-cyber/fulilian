...
def _default_registry_path() -> Path:
    return get_fulilian_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_fulilian_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_fulilian_home = expected_fulilian_home if expected_fulilian_home is not None else str(get_fulilian_home())
    ...
    def _spawn_locked(self, *, reason: str) -> None:
        ...
        if self.env:
            env.update(self.env)
        env["FULILIAN_COMPUTE_HOST_HEARTBEAT_SECS"] = str(self.heartbeat_secs)
    ...
    def _validate_hello(self) -> None:
        ...
        got_home = str(hello.get("fulilian_home") or "")
        if got_home and got_home != self.expected_fulilian_home:
            raise RuntimeError(f"compute host FULILIAN_HOME mismatch: {got_home} != {self.expected_fulilian_home}")
