/**
 * Fulilian desktop plugin template. Save as:
 *   <fulilian home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <fulilian home> is ~/.fulilian by default, or ~/.fulilian/profiles/<name>
 * when running a named profile (`fulilian -p <name>`). Run `fulilian doctor` (or
 ...
 * Only these imports resolve: @fulilian/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@fulilian/plugin-sdk'
