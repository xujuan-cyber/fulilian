...
Registry of record: `fulilian_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Fulilian config+state snapshots (CLI)
...
/update                  Update Fulilian to latest
