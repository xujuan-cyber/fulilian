# SOURCE: /home/xujuan/Des-CTF-Knowledge/Des-CTF-Knowledge-main/CTF大赛WP集合/articles/2024年羊城杯粤港澳大湾区网络安全大赛WP-数据安全_AK篇.md
    ...
    if check_string('^[a-zA-Z0-9]+$', p['username'][0]):  # username
        if IsChinese(p['name'][0]):
            if validId(p['idcard'][0]) and len(p['idcard'][0]) == 18:
                if p['phone'][0][:3] in phone_head and len(p['phone'][0]) == 11:
