...
Built for [FuLiLian](https://github.com/xujuan-cyber/fulilian). Usable in any coding agent. Canonical source lives here; synced to [`xujuan-cyber/fulilian/skills/creative/ascii-video`](https://github.com/xujuan-cyber/fulilian/tree/main/skills/creative/ascii-video) via PR.
