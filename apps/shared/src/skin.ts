/**
 * Canonical Fulilian skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$FULILIAN_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`fulilian_cli/skin_engine.py`),
 ...
 *   • CLI     → `fulilian_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
