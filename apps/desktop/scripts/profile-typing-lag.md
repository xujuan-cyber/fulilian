...
cd apps/desktop
XCURSOR_SIZE=24 FULILIAN_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/fulilian-typing
# → /tmp/fulilian-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/fulilian-typing.before.heapsnapshot
# → /tmp/fulilian-typing.after.heapsnapshot
```
