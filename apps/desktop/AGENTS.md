...
How to build Fulilian Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Fulilian surface can also
...
- A **runtime home change** (switching the underlying `FULILIAN_HOME` profile) is
...
its shape. "Plugin" means several unrelated things across Fulilian — do not assume
