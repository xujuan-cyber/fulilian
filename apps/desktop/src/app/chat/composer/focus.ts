...
const FOCUS_EVENT = 'fulilian:composer-focus'
const INSERT_EVENT = 'fulilian:composer-insert'
const ATTACH_IMAGES_EVENT = 'fulilian:composer-attach-images'
const INSERT_REFS_EVENT = 'fulilian:composer-insert-refs'
const SUBMIT_EVENT = 'fulilian:composer-submit'
const VOICE_TOGGLE_EVENT = 'fulilian:composer-voice-toggle'
const MODEL_MENU_EVENT = 'fulilian:composer-model-menu'
