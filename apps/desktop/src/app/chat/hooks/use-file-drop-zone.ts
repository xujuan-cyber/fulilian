...
import { type DroppedFile, extractDroppedFiles, FULILIAN_PATHS_MIME } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, FULILIAN_PATHS_MIME) ? 'files' : null
