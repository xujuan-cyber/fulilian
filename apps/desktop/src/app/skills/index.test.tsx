...
import type * as FulilianApi from '@/fulilian'
...
vi.mock('@/fulilian', async importOriginal => ({
  ...(await importOriginal<typeof FulilianApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { fulilianDesktop?: unknown }).fulilianDesktop = { connections, getAgentRoster }
