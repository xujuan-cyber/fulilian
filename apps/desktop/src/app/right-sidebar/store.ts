...
const TAKEOVER_KEY = 'fulilian.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Fulilian can't clear via the API — the user
 *  sees exactly what runs instead of Fulilian silently deleting their creds. */
