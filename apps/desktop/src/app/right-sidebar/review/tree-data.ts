import type { FulilianReviewFile } from '@/global'
...
export function buildReviewFlatList(files: FulilianReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: FulilianReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
