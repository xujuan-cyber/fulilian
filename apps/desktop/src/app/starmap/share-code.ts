...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/fulilian'
...
const VERSION = 3
const PREFIX = 'HML' // "Fulilian Memory Loadout" — namespaces our codes like WoW's leading bytes.
