...
import { getLatestSessionMessages, type ProfileScope } from '@/fulilian'
...
interface BackgroundSyncParams {
  ...
  refreshFulilianConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshFulilianConfig])
}
