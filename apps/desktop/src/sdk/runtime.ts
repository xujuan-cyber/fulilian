 ...
 * plugins resolve `@fulilian/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __FULILIAN_PLUGIN_SDK__: sdk,
  __FULILIAN_REACT__: React,
  __FULILIAN_REACT_JSX__: jsxRuntime,
  __FULILIAN_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@fulilian/plugin-sdk': shimUrl('__FULILIAN_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__FULILIAN_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__FULILIAN_REACT_JSX__'),
    react: shimUrl('__FULILIAN_REACT__')
  }
