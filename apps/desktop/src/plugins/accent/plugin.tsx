...
import type { FulilianPlugin, PaletteContribution } from '@fulilian/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@fulilian/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: FulilianPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
