...
test('generated protocol uses fulilian profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `fulilian profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `fulilian profiles list` for the LIVE/)
})
