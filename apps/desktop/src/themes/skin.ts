/**
 * Fulilian skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$FULILIAN_HOME/skins/` (or a
 * built-in) resolved by `fulilian_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Fulilian authors from a prompt lights up all three surfaces from one file.
 *
...
import type { FulilianSkin, SkinColors } from '@fulilian/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: FulilianSkin): DesktopTheme | null {
