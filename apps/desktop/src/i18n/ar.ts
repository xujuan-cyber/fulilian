...
export const ar = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      envOverrideDesc:
        'أزل FULILIAN_DESKTOP_REMOTE_URL و FULILIAN_DESKTOP_REMOTE_TOKEN لاستخدام الإعداد المحفوظ أدناه.',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `فتحنا ${provider} في المتصفح. صرّح لـ Fulilian هناك وسيتم الاتصال تلقائياً دون نسخ أو لصق.`,
