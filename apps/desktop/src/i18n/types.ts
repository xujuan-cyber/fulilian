...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingFulilianDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshFulilianPathTitle: string
      sshFulilianPathDesc: string
      sshFulilianPathPlaceholder: string
  ...
  commandCenter: {
    ...
    fulilianActiveSessions: (version: string, count: number) => string
