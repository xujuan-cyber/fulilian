...
export const en: Translations = {
  ...
  boot: {
    ready: 'Fulilian Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Fulilian settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Fulilian backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingFulilianDesktop: 'Starting Fulilian Desktop…'
    },
    errors: {
      backgroundExited: 'Fulilian background process exited.',
      backgroundExitedDuringStartup: 'Fulilian background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Fulilian backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateFulilian: 'Update Fulilian',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Fulilian Desktop.',
    ...
    native: {
      ...
      inputBody: 'Fulilian is waiting for your response.',
      turnDoneTitle: 'Fulilian finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `fulilian debug share --nous` from a terminal, or `fulilian debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Fulilian defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Fulilian backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Fulilian backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.fulilian/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Fulilian is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Fulilian asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Fulilian was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Fulilian was in the background.'
        }
      },
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Fulilian can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Fulilian when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Fulilian walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Fulilian is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Fulilian, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Fulilian Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Fulilian runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Fulilian checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Fulilian configuration...',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Fulilian gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Fulilian Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Fulilian Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Fulilian runtime managed by this app.',
      kindRemoteDesc: 'A Fulilian gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Fulilian Cloud account.',
      kindSshDesc: 'A Fulilian install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Fulilian manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Fulilian Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Fulilian backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset FULILIAN_DESKTOP_REMOTE_URL and FULILIAN_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      cloudTitle: 'Fulilian Cloud',
      cloudDesc: 'Sign in once to Fulilian Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Fulilian Cloud',
      cloudSignIn: 'Sign in to Fulilian Cloud',
      cloudSignedIn: 'Signed in to Fulilian Cloud',
      cloudNeedsSignIn: 'Sign in to Fulilian Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Fulilian Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Fulilian Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Fulilian Cloud',
      cloudSignedOutMessage: 'Cleared the Fulilian Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /fulilian.',
      ...
      restartingMessage: 'Fulilian Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Fulilian ${version}` : ''}`,
      ...
      sshDesc:
        'Fulilian is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshFulilianPathTitle: 'Fulilian path (optional)',
      sshFulilianPathDesc: 'Full path to the remote fulilian binary. Blank = auto-detect.',
      sshFulilianPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Fulilian found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Fulilian runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Fulilian is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/xujuan-cyber/fulilian/main/scripts/install.sh | sh) or set the Fulilian path.',
      sshErrPlatform:
        'Unsupported remote platform. Fulilian Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Fulilian on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Fulilian. Review the exact configuration below — it comes from the link, not from Fulilian.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Fulilian runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Fulilian at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via fulilian curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Fulilian builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Fulilian to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Fulilian to generate pets.',
      backgroundHint: 'You can close this — Fulilian will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Fulilian desktop' },
    ...
    fulilianActiveSessions: (version, count) => `Fulilian ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@fulilian:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Fulilian environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Fulilian did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Fulilian will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Fulilian backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Fulilian. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Fulilian backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Fulilian...',
    placeholderReconnecting: 'Reconnecting to Fulilian…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Fulilian a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Fulilian will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Fulilian to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Fulilian…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Fulilian…',
    ...
    unsupportedMessage: 'This version of Fulilian can’t update itself from inside the app.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Fulilian desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Fulilian updater takes over in its own window and reopens Fulilian automatically when it’s done. Please don’t reopen Fulilian yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Fulilian reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Fulilian reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Fulilian?',
    blockerBody:
      'Fulilian needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Fulilian',
    foreignBlockerBody:
      'Fulilian can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Fulilian can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Fulilian needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Fulilian Desktop',
    setupChoiceDesc:
      'Connect this app to a Fulilian gateway you already run, or install Fulilian locally on this computer.',
    connectExistingTitle: 'Connect to existing Fulilian',
    ...
    installLocalTitle: 'Install Fulilian locally',
    ...
    probeError: 'Could not reach that Fulilian gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up FuLiLian',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Fulilian CLI or desktop instance is running. Stop any running Fulilian instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with FuLiLian",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Fulilian is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Fulilian…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Fulilian',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Fulilian connects automatically',
    ...
    authorizeThere: 'Authorize Fulilian there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Fulilian there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Fulilian Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Fulilian Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Fulilian will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Fulilian is restarting...',
      askRestart: 'Ask Fulilian to restart the server',
      lookingRestart: taskId => `Fulilian is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Fulilian is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Fulilian to open a page.',
      finishedRestarting: message => `Fulilian finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Fulilian could not restart the server.',
      stillWorking:
        'Fulilian is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Fulilian is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Fulilian gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.fulilian/config.yaml). Fulilian won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Fulilian needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Fulilian needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Fulilian Desktop to use Save Image.',
    restartToSaveImages: 'Restart Fulilian Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `fulilian gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Fulilian loads when the work calls for them.'
      },
      messaging: {
        title: 'Fulilian away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Fulilian made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Fulilian — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
