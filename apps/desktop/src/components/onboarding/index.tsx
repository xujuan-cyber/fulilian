...
import type { ModelOptionProvider, OAuthProvider } from '@/types/fulilian'
...
// onboarding / Providers key form lists every `api_key` provider `fulilian model`
...
const SHOW_ALL_KEY = 'fulilian-onboarding-show-all-v1'
