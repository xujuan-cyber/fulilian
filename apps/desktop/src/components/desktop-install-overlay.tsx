 ...
 *
 * Renders the first-launch install progress for FuLiLian. Mounted always;
...
export function DesktopInstallOverlay({ enabled = true }: DesktopInstallOverlayProps) {
  ...
  // there's no FuLiLian installed yet and we can't drive install.sh
        ...
        <div className="w-full max-w-xl rounded-xl border border-(--stroke-nous) bg-card p-8 shadow-nous">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 flex items-center gap-2">
              ...
              <Button
                onClick={() => {
                  window.fulilianDesktop?.openExternal?.(ups.docsUrl)
                }}
                size="sm"
                variant="ghost"
              >
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await window.fulilianDesktop?.cancelBootstrap?.()
                  } catch {
          ...
          <div className="flex-shrink-0 bg-card p-4">
            <div className="flex items-center justify-between gap-2">
              <span className="text-xs text-muted-foreground">
                ...
                <code className="font-mono text-(--ui-text-secondary)">%LOCALAPPDATA%\fulilian\logs\</code>
              </span>
              <div className="flex gap-2">
                ...
                <Button
                  onClick={async () => {
                    ...
                    try {
                      await window.fulilianDesktop?.resetBootstrap?.()
                    } catch {
