...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/fulilian-agent')).toBe('~/www/fulilian-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/fulilian-agent')).toBe('fulilian-agent')
    expect(pathLeaf('~/www/fulilian-agent')).toBe('fulilian-agent')
