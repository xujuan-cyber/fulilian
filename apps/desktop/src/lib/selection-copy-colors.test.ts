...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.fulilianMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.fulilianMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.fulilianMode = 'light'
