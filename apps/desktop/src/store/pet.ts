...
export interface PetInfo {
  ...
  // the Fulilian "run" activity state uses the in-place running row).
 ...
 * FULILIAN_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'fulilian.desktop.pet-roam.v1'
