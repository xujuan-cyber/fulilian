...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://fulilian.example.com:8443/x')).toBe('fulilian.example.com:8443')
    expect(remoteHostLabel('https://fulilian.example.com:443')).toBe('fulilian.example.com')
    expect(remoteHostLabel('http://fulilian.example.com:80')).toBe('fulilian.example.com')
  })
