...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('fulilian.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('fulilian.desktop.unreadFinishedSessions')
