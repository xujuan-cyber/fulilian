...
function identityForConnection(connection: FulilianConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: FulilianConnection | null): void {
