 ...
 * `<fulilian home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'fulilian.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'fulilian.desktop.disabledPlugins.v1'
