...
test('parentWatchdogEnv emits an exact identity when the marker is available', () => {
  assert.deepEqual(parentWatchdogEnv(42, 'winms:1723456789123', 'nonce-1'), {
    FULILIAN_PARENT_NONCE: 'nonce-1',
    FULILIAN_PARENT_PID: '42',
    FULILIAN_PARENT_START_MARKER: 'winms:1723456789123',
    // Spawn tag mirrored by fulilian_cli/process_identity.py — spawner create
    // time in seconds derived from the same winms marker.
    FULILIAN_SPAWN: 'v1:-:serve:42:1723456789.123'
  })
})
