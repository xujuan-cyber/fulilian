 ...
 * startFulilian() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startFulilian() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startFulilian`, re-emits
