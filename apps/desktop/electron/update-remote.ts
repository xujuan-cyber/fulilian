 ...
 *
 * A public install can end up with `origin=git@github.com:xujuan-cyber/fulilian.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/xujuan-cyber/fulilian.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/xujuan-cyber/fulilian'
