...
// even though a fresh shell — and the Fulilian CLI — sees it immediately. The
// desktop's FULILIAN_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\fulilian. Reading
...
//       FULILIAN_HOME    REG_SZ    F:\Fulilian\data
//
