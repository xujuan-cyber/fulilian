...
# by /etc/cont-init.d/01-fulilian-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs fulilian"
...
echo "[fulilian] WARNING: docker/entrypoint.sh is a deprecated shim under " \
